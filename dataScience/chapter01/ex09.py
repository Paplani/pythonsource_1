...
"""
- 두개의 DataFrame을 공통 키(학번) 기준으로 합치는(merge) 방법
...
student_info = pd.read_csv("dataScience/data/student_info.csv", encoding="utf-8-sig")
student_scores = pd.read_csv("dataScience/data/student_scores.csv", encoding="utf-8-sig")
...
# 3. how = "left" : 왼쪽(student_info) -> 부모기준으로 전부 유지, 없는 성적은 NaN
