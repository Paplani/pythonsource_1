...
df = pd.read_csv("dataScience/data/webtoon_ranking.csv", encoding='utf-8-sig')
print("=== 원본 데이터 ===")
print(df)
...
# 2. 별점 기준 오름차순
by_rating = df.sort_values("별점", ascending=True)
print("\n === 별점 낮은 순 ===")
print(by_rating[["웹툰제목", "조회수", "별점"]])
...
print("\n=== 순위 컬럼 추가 ===")
print(df[["장르", "웹툰제목", "조회수순위"]].sort_values("조회수순위"))
